    ...
    public partial class __Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentLessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentLessions_Lessions_LessionId",
                        column: x => x.LessionId,
                        principalTable: "Lessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentLessions_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentLessions_LessionId",
                table: "StudentLessions",
                column: "LessionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentLessions_StudentId",
                table: "StudentLessions",
                column: "StudentId");
        }
